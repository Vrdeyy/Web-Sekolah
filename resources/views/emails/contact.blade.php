...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #4f2744;">Pesan Baru dari Website Sekolah</h2>
        ...
        <div
            style="margin-top: 20px; background: #f9f9f9; padding: 15px; border-radius: 5px; border-left: 4px solid #4f2744;">
