                ...
                <div class="flex flex-wrap justify-center gap-6">
                    @if(($settings['ppdb_active'] ?? false))
                        <div data-aos="fade-up" data-aos-delay="400">
                            <a href="{{ $settings['ppdb_url'] ?? '#' }}" target="_blank"
                                class="inline-flex items-center gap-4 px-12 py-5 bg-gradient-to-r from-[#F8CB62] to-[#f5b82e] text-[#612F73] font-black rounded-2xl hover:shadow-golden transition-all duration-500 hover:-translate-y-1 transform uppercase text-xs tracking-widest">
                    ...
                    <div data-aos="fade-up" data-aos-delay="{{ ($settings['ppdb_active'] ?? false) ? 500 : 400 }}">
                        <a href="{{ route('contact') }}"
                            class="inline-flex items-center gap-4 px-12 py-5 bg-white/10 backdrop-blur-md text-white font-black rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-500 hover:-translate-y-1 transform uppercase text-xs tracking-widest">
