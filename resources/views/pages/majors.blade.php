...
@section('content')
    ...
    <section class="pt-28 pb-16 bg-premium-dark relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto" data-aos="fade-up">
                <div
                    class="inline-flex items-center gap-2 px-6 py-3 bg-[#8C51A5]/20 backdrop-blur-md rounded-full text-[#F0E7F8] text-sm font-bold mb-6 border border-[#8C51A5]/30 shadow-lg" data-aos="fade-down" data-aos-delay="200">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-6 tracking-wide drop-shadow-lg" data-aos="zoom-in" data-aos-delay="400">
                    Jurusan <span class="text-[#F8CB62] bg-gradient-to-r from-[#F8CB62] to-[#D668EA] bg-clip-text text-transparent">Unggulan</span>
                </h1>
    ...
    <section class="py-16 bg-[#F0E7F8]/30 relative overflow-hidden">
     ...
     {{-- CTA Section --}}
    <section
        class="py-24 bg-premium-dark relative overflow-hidden border-t border-white/5">
        @include('partials.awards-shapes')
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
