        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex flex-wrap items-center justify-center gap-8 md:gap-16">
                <div class="text-center group">
                    <div class="text-4xl font-extrabold text-[#932F80] mb-1 transition-transform group-hover:scale-110">{{ $majors->count() }}</div>
                ...
                <div class="text-center group">
                    <div class="text-4xl font-extrabold text-[#932F80] mb-1 transition-transform group-hover:scale-110">4 Tahun</div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($majors as $major)
                    <article
                        ...
                        {{-- Image --}}
                        <a href="{{ route('major.show', $major->slug) }}" class="block relative h-56 overflow-hidden bg-gray-100">
                            @if($major->image)
                            ...
                            @if($major->short_name)
                                <div class="absolute top-4 left-4">
                                    <span class="px-4 py-2 bg-[#932F80] text-white text-sm font-bold rounded-lg shadow-lg border border-white/20">
                                        {{ $major->short_name }}
                                    </span>
                                </div>
                            @endif
    ...
    <section class="py-24 bg-gradient-to-br from-[#1A0E17] via-[#2A1424] to-[#12080F] relative overflow-hidden border-t border-white/10">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-tight">Tertarik Bergabung?</h2>
                <p class="text-gray-300 text-lg md:text-xl mb-10 leading-relaxed">Daftarkan diri Anda sekarang dan jadilah bagian dari keluarga besar kami!</p>
