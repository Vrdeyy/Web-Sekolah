        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-gray-300 text-lg md:text-xl leading-relaxed">
                    Tenaga kependidikan yang mendukung operasional profesional di {{ $settings['school_name'] ?? 'SMK YAJ' }}
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-center">
                ...
                <div class="group p-8 rounded-3xl bg-purple-50 border border-purple-100 hover:border-[#932F80]/50 transition-all duration-500 transform hover:-translate-y-2">
                    <div class="text-4xl font-extrabold text-[#932F80] mb-2 leading-none group-hover:scale-110 transition-transform">{{ $staff->count() }}</div>
                ...
                <div class="group p-8 rounded-3xl bg-blue-50 border border-blue-100 hover:border-blue-500/50 transition-all duration-500 transform hover:-translate-y-2">
                    <div class="text-4xl font-extrabold text-blue-600 mb-2 leading-none group-hover:scale-110 transition-transform">EXCELLENT</div>
                ...
                @foreach($staff as $member)
                    <article
                        ...
                        <div class="space-y-3">
                            ...
                            @if($member->position)
                                <p class="text-[#932F80] text-xs font-extrabold uppercase tracking-widest">{{ $member->position }}</p>
                            @endif
                            ...
                            @if($member->department)
                                <div class="inline-flex items-center gap-2 px-3 py-1 bg-gray-50 rounded-lg border border-gray-100">
                                    ...
                                    <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">{{ $member->department }}</span>
                                </div>
                            @endif
    ...
    <section class="py-24 bg-gradient-to-br from-[#1A0E17] via-[#2A1424] to-[#12080F] relative overflow-hidden border-t border-white/10">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <p class="text-gray-300 text-lg md:text-xl mb-12 font-medium">Tim kami siap membantu Anda dengan berbagai kebutuhan administrasi dan informasi di lingkungan sekolah.</p>
