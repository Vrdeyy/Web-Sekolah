    ...
    <section class="py-12 bg-white relative border-b border-[#F0E7F8]">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto text-center">
                {{-- Stat 1 --}}
                <div class="group p-8 rounded-[2rem] bg-[#F0E7F8]/50 border border-[#8C51A5]/10 hover:shadow-premium-lg transition-all duration-700 transform hover:-translate-y-2"
                ...
                {{-- Stat 2 --}}
                <div class="group p-8 rounded-[2rem] bg-[#8C51A5]/5 border border-[#8C51A5]/10 hover:shadow-premium-lg transition-all duration-700 transform hover:-translate-y-2"
                ...
                {{-- Stat 3 --}}
                <div class="group p-8 rounded-[2rem] bg-[#F8CB62]/5 border border-[#F8CB62]/10 hover:shadow-premium-lg transition-all duration-700 transform hover:-translate-y-2"
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @foreach($staff as $index => $member)
                    <article
                        class="group bg-white rounded-[2.5rem] overflow-hidden border border-[#8C51A5]/10 shadow-xl shadow-[#612F73]/5 hover:shadow-premium-lg hover:border-[#8C51A5]/30 transition-all duration-700 hover:-translate-y-2 text-center p-10"
                        ...
                        <div class="space-y-4">
                            ...
                            @if($member->department)
                                <div class="flex items-center justify-center gap-2 text-gray-400">
                                    ...
                                    <span class="text-[10px] font-black uppercase tracking-widest">{{ $member->department }}</span>
                                </div>
                            @endif
