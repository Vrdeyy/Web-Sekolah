        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto text-center">
                ...
                <div data-aos="fade-up" data-aos-delay="300">
                    <div class="group h-full p-8 rounded-[2rem] bg-[#F8CB62]/5 border border-[#F8CB62]/10 hover:shadow-2xl transition-all duration-500 ease-in-out transform hover:-translate-y-2 hover:scale-[1.02]">
                        <div
