    ...
    <section class="pt-28 pb-16 bg-premium-dark relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto" data-aos="fade-up">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-6 tracking-tight drop-shadow-lg uppercase" data-aos="zoom-in" data-aos-delay="400">
                    Kontak <span class="text-[#F8CB62] bg-gradient-to-r from-[#F8CB62] to-[#D668EA] bg-clip-text text-transparent">Layanan</span>
                </h1>
                <p class="text-gray-400 text-lg md:text-xl font-medium leading-relaxed" data-aos="fade-up" data-aos-delay="600">
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid lg:grid-cols-3 gap-10">
                ...
                <div class="lg:col-span-2" data-aos="fade-left">
                    <div class="bg-white rounded-[2.5rem] overflow-hidden border border-[#8C51A5]/10 shadow-premium-lg h-full p-4">
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-16" data-aos="fade-up">
                    <div class="inline-flex items-center gap-2 px-6 py-2 bg-white rounded-full text-[#8C51A5] text-[10px] font-black mb-4 border border-[#8C51A5]/10 shadow-sm uppercase tracking-widest">
                        Hubungi Kami
                    </div>
                ...
                @if(session('success'))
                <div class="mb-10 p-6 bg-[#F0E7F8] border border-[#8C51A5]/20 text-[#612F73] rounded-[2rem] flex items-center gap-4 shadow-premium-lg" data-aos="zoom-in">
                ...
                <form action="{{ route('contact.send') }}" method="POST" class="bg-white rounded-[3rem] p-10 md:p-14 border border-[#8C51A5]/10 shadow-premium-lg space-y-10" data-aos="fade-up">
                    @csrf
                    <div class="grid md:grid-cols-2 gap-10">
                        <div data-aos="fade-up" data-aos-delay="100">
                            <label class="block text-[10px] font-black text-gray-400 mb-4 tracking-[0.2em] uppercase">Nama Lengkap</label>
                            <div class="relative">
                        ...
                        <div data-aos="fade-up" data-aos-delay="200">
                            <label class="block text-[10px] font-black text-gray-400 mb-4 tracking-[0.2em] uppercase">Alamat Email</label>
                            <div class="relative">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300">
                        <label class="block text-[10px] font-black text-gray-400 mb-4 tracking-[0.2em] uppercase">Subjek Pesan</label>
                        <div class="relative">
                    ...
                    <div data-aos="fade-up" data-aos-delay="400">
                        <label class="block text-[10px] font-black text-gray-400 mb-4 tracking-[0.2em] uppercase">Isi Pesan</label>
                        <div class="relative">
