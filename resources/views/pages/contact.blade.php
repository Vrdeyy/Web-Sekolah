    ...
    <section class="py-24 bg-purple-50 relative overflow-hidden border-t border-purple-100">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <form action="#" method="POST" class="bg-white rounded-3xl p-10 border border-purple-100 shadow-xl space-y-8">
                    @csrf
    ...
    <section class="py-24 bg-white relative border-t border-gray-100">
        <div class="container mx-auto px-4 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <a href="{{ route('news') }}"
                    class="group p-8 bg-purple-50 rounded-3xl border border-purple-100 shadow-lg hover:shadow-blue-500/20 hover:border-blue-500/50 transition-all duration-500 text-center transform hover:-translate-y-2">
                    <div
                ...
                <a href="{{ route('gallery.photos') }}"
                    class="group p-8 bg-purple-50 rounded-3xl border border-purple-100 shadow-lg hover:shadow-pink-500/20 hover:border-pink-500/50 transition-all duration-500 text-center transform hover:-translate-y-2">
                    <div
                ...
                @else
                    <a href="{{ route('achievements') }}"
                        class="group p-8 bg-purple-50 rounded-3xl border border-purple-100 shadow-lg hover:shadow-amber-500/20 hover:border-amber-500/50 transition-all duration-500 text-center transform hover:-translate-y-2">
                        <div
