        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-8 md:gap-12">
                ...
                <article class="lg:col-span-8">
                    ...
                    {{-- Promo / Visit CTA --}}
                    <div class="bg-white/50 backdrop-blur-sm border border-[#8C51A5]/10 rounded-3xl md:rounded-[3rem] p-8 md:p-14 mb-14 shadow-premium-lg flex flex-col md:flex-row items-center gap-10"
                        data-aos="fade-up">
                        <div class="w-24 h-24 bg-[#8C51A5] rounded-[2rem] flex items-center justify-center shadow-lg flex-shrink-0"
                            data-aos="zoom-in" data-aos-delay="200">
                            <i class="fas fa-shopping-cart text-4xl text-white"></i>
                        </div>
                        <div class="text-center md:text-left">
                            <h3 class="text-2xl font-black text-[#612F73] mb-3 tracking-tight" data-aos="fade-left"
                                data-aos-delay="300">Kunjungi Business Center
                                Kami</h3>
                            <p class="text-gray-500 mb-6 leading-relaxed" data-aos="fade-left" data-aos-delay="400">Nikmati
                                produk dan layanan terbaik hasil karya
                                siswa {{ $settings['school_name'] ?? 'SMK YAJ' }}.</p>
                            @if($businessCenter->phone)
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $businessCenter->phone) }}"
                                    target="_blank"
                                    class="inline-flex items-center gap-4 px-10 py-4 bg-[#25D366] text-white font-black rounded-2xl hover:bg-[#128C7E] transition-all shadow-xl hover:-translate-y-1 transform"
                ...
                <aside class="lg:col-span-4 space-y-8 md:space-y-12">
                    ...
                    <div class="bg-white border border-[#8C51A5]/10 rounded-3xl md:rounded-[2.5rem] p-6 md:p-8 shadow-premium-lg"
                        ...
                        <ul class="space-y-6">
                            <li class="flex items-center gap-5 pb-6 border-b border-gray-50 group" data-aos="fade-left"
                                data-aos-delay="100">
                                <div
